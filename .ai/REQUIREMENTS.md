...
| --- | --- | --- | --- | --- |
| PRD-001 | Internal Developer Platform with Backstage MVP | Approved | Platform team | `docs/prd/001-backstage-idp-mvp.md` |

## Current requirements

The MVP plan was supplied directly by the requester and is tracked as PRD-001.
