...
- Planning documentation: verify Markdown links and repository file inventory.
- Git foundation: inspect `git status` after initialization and commits.

Backstage, Docker and CI validation commands will be added after their configuration exists.
