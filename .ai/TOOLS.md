...
- GitHub CLI (`gh`) is installed, but the configured `crilsen` authentication token is invalid as observed during bootstrap.
- No project runtime, package manager configuration, Docker configuration or cloud tooling exists yet.
